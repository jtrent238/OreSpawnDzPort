  ...
  extends Item
{
  ...
  public boolean func_77648_a(ItemStack par1ItemStack, EntityPlayer par2EntityPlayer, World par3World, int par4, int par5, int par6, int par7, float par8, float par9, float par10)
  {
    ...
    Entity ent = spawn_something(this.my_id, par3World, par4 + 0.5D, par5 + 1.01D, par6 + 0.5D);
    if (ent != null) {
      if (((ent instanceof EntityLiving)) && (par1ItemStack.isStackable())) {
  ...
  */
  ...
  {
    this.field_77791_bV = iconRegister.func_94245_a("OreSpawn:" + func_77658_a().substring(5));
  }
  */
}
