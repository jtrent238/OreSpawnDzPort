...
{	
    public static final String[][] field_149860_M = new String[][] {{"flower_pink"}, {"flower_purple"}, {"flower_red"}, {"flower_yellow"}};
    ...
    public BlockModFlower(int p_i2173_1_)
    {
        ...
        this.setBlockTextureName("orespawndzport:" + field_149860_M);
    }
